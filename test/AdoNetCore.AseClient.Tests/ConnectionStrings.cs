...
namespace AdoNetCore.AseClient.Tests
{
    public static class ConnectionStrings
    {
        ...
        public static string PasswordEncrypted2 => $"{Prefix}; Pooling=true; LoginTimeOut=1; Max Pool Size=32; EncryptPassword=1; UniqueID=2";
        public static string PasswordEncrypted3 => $"{Prefix}; Pooling=true; LoginTimeOut=1; Max Pool Size=32; EncryptPassword=1; UniqueID=3";
