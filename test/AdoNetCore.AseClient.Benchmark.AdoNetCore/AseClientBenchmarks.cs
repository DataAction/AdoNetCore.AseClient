...
namespace AdoNetCore.AseClient.Benchmark.AdoNetCore
{
#if DEBUG
    [TestFixture]
#endif
...
(
    ...
    [Value] INT DEFAULT 1 NOT NULL
        ...
        {
            // Arrange.
            var benchmark = new AseClientBenchmarks();

            // Act.
            var result = benchmark.SingleQueryForSingleRecordWithUnpooledConnection();
        ...
        public void Benchmark_SingleQueryForSingleRecordWithPooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.SingleQueryForSingleRecordWithPooledConnection();
        ...
        public void Benchmark_SingleQueryForMultipleRecordsWithPooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.SingleQueryForMultipleRecordsWithPooledConnection();
        ...
        public void Benchmark_SingleQueryForMultipleRecordsWithUnpooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.SingleQueryForMultipleRecordsWithUnpooledConnection();
        ...
        public void Benchmark_MultipleQueriesForMultipleRecordsWithPooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.MultipleQueriesForMultipleRecordsWithPooledConnection();
        ...
        public void Benchmark_MultipleQueriesForMultipleRecordsWithUnpooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.MultipleQueriesForMultipleRecordsWithUnpooledConnection();
        ...
        public void Benchmark_UpdateMultipleRecordsWithPooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.UpdateMultipleRecordsWithPooledConnection();
        ...
        public void Benchmark_UpdateMultipleRecordsWithUnpooledConnection_ReturnsData()
        {
            ...
            // Act.
            var result = benchmark.UpdateMultipleRecordsWithUnpooledConnection();
